...
<head>
    ...
    <title>Temos uma novidade para você! 🎉</title>
    <style>
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>Temos uma novidade fresquinha para você! 🎉</h1>
        </div>
        <div class="content">
            <img src="{{ $imgHeader }}" alt="Imagem de destaque da postagem"
                style="max-width: 100%; height: auto; margin-bottom: 20px;">
            <hr style="border-color: #4b5563; margin-bottom: 20px;">
            <p>Olá, **{{ $mail }}**!</p>
            <p>Prepare-se para uma leitura incrível! Acabamos de publicar um novo post e mal podemos esperar para que
                você confira.</p>
            <p>O assunto de hoje é: <strong>"{{ $title }}"</strong>. Parece interessante, não é?</p>
            <p>Clique no botão abaixo para mergulhar no conteúdo e descobrir tudo que preparamos para você:</p>
            <p style="margin-top: 30px;">
                <a href="{{ route('posts.show', ['slug' => $slug]) }}" class="button">Leia a Postagem Agora!</a>
            </p>
        </div>

        <div class="footer">
            <p>Gostou? Sinta-se à vontade para se conectar comigo nas redes sociais! 👇</p>
            ...
            <p>Não quer mais receber novidades? <a href="{{ route('newslatter.unregister', [
    'mail' => $mailEncode,
    'decode' => true
]) }}" target="_blank" style="color: #E5E7EB; text-decoration: underline;">Cancele sua
                    inscrição aqui</a>.</p>
            <p style="color: #E5E7EB;">&copy; 2025 - About Software. Todos os direitos reservados.</p>
        </div>
    </div>
</body>
